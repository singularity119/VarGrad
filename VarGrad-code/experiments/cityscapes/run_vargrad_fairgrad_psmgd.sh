...
SAVE_DIR="${SAVE_DIR:-/root/autodl-tmp/exp_logs_save/vargrad_reimpl/cityscapes/save}"
LOG_ROOT="${LOG_ROOT:-/root/autodl-tmp/exp_logs_save/vargrad_reimpl/cityscapes/log}"
